...
export class ChoicesController {
  ...
  @ApiResponse({ status: 201, description: 'Choice created successfully', type: Choice })
  ...
  @ApiResponse({ status: 200, description: 'List of all choices', type: [Choice] })
  ...
  @ApiResponse({ status: 200, description: 'Choice updated successfully', type: Choice })
  @ApiResponse({ status: 404, description: 'Choice not found' })
  async update(@Param('id') id: string, @Body() updateChoiceDto: UpdateChoiceDto): Promise<Choice> {
